                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      myButton('Go to Login',context,LoginPage()),
                    ],
                  ),
                ),
              ),
                          ...
                          Stack(
                            children: [
                              CircleAvatar(
                                  ...
                                  backgroundImage: authCubit.userModel?.image == null  && authCubit.userModel!.image.isNotEmpty ? NetworkImage(authCubit.userModel!.image) : NetworkImage('https://static.vecteezy.com/system/resources/previews/007/296/447/non_2x/user-icon-in-flat-style-person-icon-client-symbol-vector.jpg')
                              ),
                              Positioned(
                                bottom: 0,
                                right: 4,
